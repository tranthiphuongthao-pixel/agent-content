---
name: branding-check
description: Chạy skill kiểm tra mức độ áp dụng branding cho các bài viết SEO của một dự án.
---
...
Script chính nằm ở `agents/branding-check/skill.py`.

```
agents/branding-check/
